...
describe Dictionary do
  ...
  it "finds an entry" do
    @d.add(:fish, 'aquatic animal')
    expect(@d.find(:fish)).to be == {fish: 'aquatic animal'}
  end
  ...
  it 'finds multiple matches from a prefix and returns the entire entry (keyword + definition)' do
    ...
    expect(@d.find('fi')).to be == {fish: 'aquatic animal', fiend: 'wicked person'}
  end
  ...
  it 'lists keywords alphabetically' do
    ...
    @d.add(:fish, 'aquatic animal')
    @d.add(:apple, 'fruit')
    expect(@d.keywords).to be == [:apple, :fish, :zebra]
  end
  ...
  it 'can produce printable output like so: [keyword] "definition"' do
    ...
    @d.add(:fish, 'aquatic animal')
    @d.add(:apple, 'fruit')
    expect(@d.printable).to be == %Q{[apple] "fruit"\n[fish] "aquatic animal"\n[zebra] "African land animal with stripes"}
  end
end

# BELOW Original tests code:
# # # Topics
# #
# # * Hash
# # * Array
